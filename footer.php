...
<footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Special Gauges Designing</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Gauging Equipment's Designing</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Jigs and Fixtures Designing</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Making the details drawings from the Cad model</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">General design services</a></li>
            </ul>
          </div>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Precision Gauges and Tools</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        Developed by <a href="https://www.incredibletechsolve.com/" target="_blank">Incredible</a>
      </div>
    </div>
  </footer>
