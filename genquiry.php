...
<div id="central">
	<div class="content">
		...
		<form id="frmContact" action="" method="POST" novalidate="novalidate" class="php-email-form">
			...
			<div class="field">			
				<input type="text" id="phone" name="phone" placeholder="enter your phone number here" title="Please enter your phone number" class="required phone form-control" aria-required="true" required>
			</div>
			<div class="label">Comments:</div>
			<div class="field">			
				<textarea id="comment-content" name="content" placeholder="enter your comments here" class="form-control"></textarea>			
			</div>
